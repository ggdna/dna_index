---
name: index
description: Creates or updates the repository index.md from the index guide and template. Use when the user says "/index" or asks for the repo overview.
---
...
Read `doc/guides/index-guide.md` and `doc/templates/index-template.md`
and follow them.

## 1. Check whether the index is current

Report a missing `index.md`.
